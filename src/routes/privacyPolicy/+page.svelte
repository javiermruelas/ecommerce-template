<p class="w-90 mx-auto mt-2" style="padding-right: 5%; padding-left: 5%;">
    <p class="text-left font-normal mb-2 mt-2 !bg-surface-800">

<h1>Privacy Policy</h1>

<p>
 This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from simple-ecommerce.com (the &ldquo;Site&rdquo;).</p>
...
<p> - &ldquo;Cookies&rdquo; are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit http://www.allaboutcookies.org.<br />
...
<div class="item-title">DATA RETENTION</div>
 <p>When you place an order through the Site, we will maintain your Order Information for our records unless and until you ask us to delete this information.</p>

<div class="item-title"> CHANGES</div>
<p>We may update this privacy policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal or regulatory reasons.<p/>
<div class="item-title">CONTACT US</div>
<p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at javiermruelas@gmail.com or by mail using the details provided below:</p>

<p> 1050 Wellness Pl, Henderson, NV, 89011, United States</p>